pipeline {
  ...
  environment {
    ...
    EXT_USER = 'minio'
    EXT_REPO = 'minio'
    BUILD_VERSION_ARG = 'MINIO_VERSION'
    IG_USER = 'imagegenius'
    IG_REPO = 'docker-minio'
    CONTAINER_NAME = 'minio'
    DOCKERHUB_IMAGE = 'imagegenius/minio'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/imagegenius/docker-minio/packages\" \
          --label \"org.opencontainers.image.source=https://github.com/imagegenius/docker-minio\" \
          ...
          --label \"org.opencontainers.image.description=[Minio](https://min.io/) is a High Performance Object Storage released under GNU Affero General Public License v3.0. It is API compatible with Amazon S3 cloud storage service. Use MinIO to build high performance infrastructure for machine learning, analytics and application data workloads.\" \
